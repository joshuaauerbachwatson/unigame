...
//    by the `scoring` variable in the model.  Scores are not transmitted with Player structures
//    during player discovery but are rather transmitted in GameStates during setup and play (if
//    used at all).
